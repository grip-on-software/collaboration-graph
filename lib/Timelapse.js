...
export default class Timelapse {
    ...
    create() {
        this.button = this.options.append("div")
            ...
            .attr(TOOLTIP_ATTR, this.locales.message("timelapse-title"))
    ...
    start() {
        ...
        this.button.text(this.locales.message("timelapse-complete"))
            .attr(TOOLTIP_ATTR, this.locales.message("timelapse-complete-title"));
        ...
        const column = this.options.append('div')
        ...
        column.append("button")
            .classed("button is-small tooltip", true)
            .attr("id", PAUSE_ID)
            .attr(TOOLTIP_ATTR, this.locales.message('pause-title'))
        ...
        column.append("button")
            ...
            .attr(TOOLTIP_ATTR, this.locales.message('speed-slower-title'))
        ...
        column.append("button")
            ...
            .attr(TOOLTIP_ATTR, this.locales.message('speed-faster-title'))
    ...
    tick() {
        if (this.paused) {
            ...
            this.options.select(`#${PAUSE_ID}`)
                .attr('disabled', true)
                .attr(TOOLTIP_ATTR, this.locales.message('stop-title'))
                .select('i')
    ...
    togglePlayPause() {
        if (this.paused) {
            ...
            this.paused = true;
            this.options.select(`#${PAUSE_ID}`)
                .attr(TOOLTIP_ATTR, this.locales.message('play-title'))
                .select('i')
